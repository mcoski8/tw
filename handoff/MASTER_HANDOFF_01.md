...
## Session 35 (2026-05-05) — v29 ships (gated pair_r4): 7th gating instance, biggest diagnostic-driven win

**Outcome:** v29_dt is the new ML champion at $1,807/1000h on full grid (49.80% pct_opt) and $965/1000h on prefix (61.32% pct_opt). **−$46 full / −$37 prefix vs v27**, the largest ML ship since v26. Pair category drops $1,771 → $1,674 (−$97 within-pair). Every other category bit-identical. Full:prefix ratio 1.24:1 (well-calibrated, low overfitting risk).

**Diagnostic-driven design — the chain:**

1. **User question (Session 34 close):** What about KK/AA + rainbow Rule-4-bot? Per-hand probe of K♠K♦3♠5♦9♥T♣J♠ confirmed Rule 4 picks +1.225 EV vs oracle BR +3.025 EV (Δ = $18K/1000h on this single hand). v26/v27 both already correctly route to DS-bot here.

2. **Rule 5 (Rainbow override) shipped to STRATEGY_GUIDE for human play** (Decision 063): tight structural trigger fires on 0.27% of all hands. v28 = v14 + Rule 5 = $3,032/1000h, +$1 vs v14_combined. **First successful Rule 5 in project history** (v21/v22 lost $473-$680 by firing on 5-13% of all hands). The same rainbow-bot trigger that drives Rule 5 turned out to be the missing ML feature.

3. **`distill_v27_pair.py` ran the KK/AA capture analysis.** Surprising finding: v27 is $20/1000h whole-grid WORSE than Rule 4 alone on KK/AA (regret 0.1236 EV/hand vs Rule 4's 0.0949). v27 picks Rule-4 84.6%, DS-bot 7.8%, "other" 7.6%. The 15.4% non-Rule-4 picks were systematically incorrect — overgeneralizing v25's pair-gated features. Total v27→oracle gap: $63/1000h whole-grid.

4. **v29 designed: 4-feature `pair_r4_*_g` family** targeting the missing signal (Rule-4-bot suit profile + body-card distribution). 73 features total, 486,342 leaves (+25,967 vs v27). 3/4 of new features placed in top-30 importance — strong tripwire confirmation pre-grade.

5. **v29 graded:**

| Grid | v27 | v29 | Δ |
|---|---:|---:|---:|
| Full | $1,853 / 49.27% | **$1,807 / 49.80%** | **−$46 / +0.53 pp** |
| Prefix | $1,002 / 60.80% | **$965 / 61.32%** | **−$37 / +0.52 pp** |

Pair drops $1,771 → $1,674 (−$97 within-pair, pct_opt 53.9% → 55.0%).

**Methodology lessons reinforced:**

1. **Diagnostic-first design produces 7.7× better headline-per-feature.** v27 (4 speculative high_only candidates) gained $6. v29 (4 diagnostic-driven pair features) gained $46. Same trainer config, same gating template. Difference: v29's diagnostic showed v27 LOSING to Rule 4 (a competing baseline), which prescribed feature design.

2. **Diagnostic should identify a competing baseline, not just within-leaf separation.** Session-34 high_only diagnostic showed within-leaf 0.34 EV separation but didn't compare against any non-DT alternative. Session-35 pair diagnostic explicitly compared v27 vs Rule 4 alone — and finding v27 was *losing* immediately prescribed the feature design.

3. **User intuition correlates with ML weak points.** The user-flagged hand (KK/AA + rainbow Rule-4-bot) revealed a $63/1000h whole-grid weakness that v27's headline metrics never surfaced.

4. **Categories can absorb multiple gating-template iterations.** Pair has now seen TWO independent ships (v25 −$102 + v29 −$97 = −$199/1000h within-pair vs v18e). Each iteration targeted a distinct signal axis; v29 builds on v25 rather than replacing it.

5. **Top-25/30 feature importance is a pre-grade tripwire.** v25 5/6 → +$47, v26 3/6 → +$70, v27 0/4 → +$6, v29 3/4 → +$46. Placement count is a leading indicator.

**Cycle scoreboard since Session 25 (21 ships, 7 archives, 1 doc-only, 1 mid-session bug recovery, 1 rule-strategy-only ship):**

| Cycle | Target | Result | Status |
|---|---|---:|---|
| v23 | gated trips_pair on v20 | +$5 / +$9 vs v20 | SHIPPED |
| v24 | gated composite on v23 | +$1 / +$1 vs v23 | SHIPPED |
| v25 | gated pair (v1) on v24 | +$47 / +$18 vs v24 | SHIPPED |
| v26 | gated two_pair on v25 | +$70 / +$52 vs v25 | SHIPPED |
| v27 | gated high_only-direct on v26 | +$6 / $0 vs v26 (prefix uninformative) | SHIPPED |
| v28 (rule strategy only) | Rule 5 (Rainbow override, KK/AA) | +$1 vs v14 | SHIPPED (rule-only) |
| **v29** | **gated pair_r4 (v2 of pair) on v27** | **+$46 / +$37 vs v27** | **SHIPPED — current ML champion** |

#### Session 36 priorities (priority order by expected value)

1. **Re-distill v29 on pair** to see how much KK/AA gap remains. v29 captured $46 whole-grid; the diagnostic predicted up to $62 available on KK/AA alone. Likely a notable chunk remains — a v30 = pair_r4 round-2 candidate.
...
## Sessions 75–77 — covered in CURRENT_PHASE.md rewrites + DECISIONS_LOG.md (Decisions 110–112) + SESSION_NN_*.md reports

S75: v47_xgb gradient boosting decisively NULL (Decision 110, $−1,392/1000h full grid; depth=6, n_estimators=200, lr=0.1, multi_output_tree, subsample=0.7).

S76: Cross-category setting-rank diagnostic identifies pair as next ML/rule target (Decision 111; $116.04/1000h STRUCTURE-bucket leak, never drilled with S71 lens).

S77: Pair-first deep-drill identifies LOW pair (rank 2-7) as carrier of 74.6% of pair's STRUCTURE leak ($86.54 of $116.04/1000h); 5 LOW PMID/PBOT cells carry $84.56/1000h with a single dominant mismatch pattern (v44 over-routes to SPLIT/PBOT, oracle keeps PMID); three feature hypotheses (H6/H7/H8) queued for S78 v48_dt retrain (Decision 112). Reports: SESSION_75_V47_XGB_NULL_REPORT.md, SESSION_76_DIAGNOSTIC_REPORT.md, PAIR_S77_FEATURE_HYPOTHESES.md.

---

## Session 78 — 2026-05-13 — v48_dt H6+H7+H8 pair feature pack CLEAN NULL ship at prefix grade Δ +$2/1000h; structural-redundancy doctrine empirically reconfirmed at v44 saturating regime; single-model ML feature-engineering track formally CLOSED

**Verdict: CLEAN NULL ship.** Decision 113. v44_dt remains the ML champion; v56_trips_hybrid remains the rule chain. Production state UNCHANGED for the seventh consecutive session (S72 NULL, S73 PARTIAL/NULL, S74 NULL, S75 boosting NULL, S76 diagnostic, S77 diagnostic, S78 NULL).

**What happened:**
1. **Phase 1 — Three new pair-gated feature files implemented + sanity-tested.** H6 `pair_pmid_ds_n_configs_g` (int8 0..5 — actual reachable values {0,1,3} due to deck structure for single-pair hands), H7 `pair_kicker_max_in_pair_suit_g` (bool 0/1), H8 `pair_low_pmid_safety_g` (int8 0..5, LOW-pair-only gated). All sanity tests passed (8/8 H6, 9/9 H7, 12/12 H8). H8's inline `_pair_cell_for_low()` cell-taxonomy logic cross-validated against S66's `compute_pair_structural` + `cell_for_pair_hand` on 23,377 random single-pair canonical hands: zero disagreements.
2. **Phase 2 — Persist gated parquets.** Three parquets (~18.6 MB each) persisted in parallel; each verified zero-on-non-gated. H6: 0:4.67M, 1:927K, 3:412K. H7: 0:4.61M, 1:1.40M. H8: 0:4.72M, 1:128K, 2:228K, 3:86K, 4:138K, 5:713K (level-5 PBOT_DS count matches S77 drill exactly).
3. **Phase 3 — Smoke train (100K rows, 2.5s wall).** H7 ranked #51, H8 #69, H6 #73 — all under abort-rank #80 but below top-30 ideal. Proceeded to full train per strict reading of abort gate.
4. **Phase 4 — Full train (4.8M rows, 578s wall = 9.6 min).** 2,294,001 leaves (+44,001 vs v44's 2,250,000 = +1.96%), depth=36, model size 1,285 MB. Importance ranks improved at scale: H7 #43, H8 #57, H6 #68.
5. **Phase 5 — Prefix grade (500K, n=1000).** v44 $686 → v48 $684 = **+$2/1000h**. pct_opt 67.13% → 67.19% (+0.06pp). Per-category: pair $595 → $590 (+$5 within-cat); ALL other categories byte-identical (gating works correctly). Within-pair pct_opt 69.2% → 69.3% (+0.1pp). Below +$5 abort threshold.
6. **Phase 6 — Full grade SKIPPED per S78 directive.** `prefix Δ < +$5 → NULL ship`. v48_dt model retained at data/v48_dt_model.npz for audit; production UNCHANGED.
7. **Decision 113: single-model ML feature-engineering track formally CLOSED at v44 saturating regime.** Six consecutive ML attempts NULLed in a row.

**Files (S78):**
- `analysis/scripts/pair_pmid_ds_features_gated.py` (H6) + `persist_pair_pmid_ds_gated.py`.
- `analysis/scripts/pair_kicker_align_features_gated.py` (H7) + `persist_pair_kicker_align_gated.py`.
- `analysis/scripts/pair_low_pmid_safety_features_gated.py` (H8) + `persist_pair_low_pmid_safety_gated.py`.
- `analysis/scripts/train_v48_dt.py` — full + smoke train with --max-rows.
- `analysis/scripts/strategy_v48_dt.py` — v44 strategy + 3 new feature blocks (110 features).
- `analysis/scripts/grade_v48_dt.py` — v48 vs v44 prefix/full grader.
...
- `data/v48_dt_model.npz` (1,285 MB) — full v48 DT; kept for audit only.
- `data/session78/{persist_pair_*.log, train_v48_smoke.log, train_v48_full.log, grade_v48_prefix.log}`.
- `SESSION_78_V48_DT_REPORT.md` — Phase 1-5 retrospective.
- `DECISIONS_LOG.md` — Decision 113.
- `CURRENT_PHASE.md` — rewritten for S79.
- `STRATEGY_GUIDE.md` — Part 1 SKIPPED (no strategy of record changed); front-matter date refresh.

**Methodology lessons (S78):**
1. **Structural-redundancy doctrine empirically reconfirmed at v44 saturating regime.** S77 budgeted 50% redundancy on H6+H7+H8 and predicted $30-45/1000h within-pair joint lift; observed is $5 within-pair = effective ~85-90% redundancy. Three contributors: (a) H6 only emits {0,1,3} due to deck structure; (b) H7's 1-bit signal is derivable in 2 splits from existing features; (c) H8's 5-split cell synthesis is reachable in 3-4 splits at v44's 2.25M-leaf capacity.
2. **Diagnostic quality does not predict feature lift.** S77 produced the project's cleanest diagnostic (sharp gap_2nd 0.385, single dominant mismatch class with $10.97/1000h on 3,072 hands). The features built from it captured 1/10 of predicted lift. **Diagnostic precision and feature lift are orthogonal at saturation.**
3. **Future feature-engineering hypotheses at v44 regime should assume 80%+ default redundancy budget**, not 50%. The S77 50%-budget proved too optimistic.
4. **Empirical value-distribution pre-flight check is now mandatory.** H6's planned 0..5 reduces to {0,1,3} due to deck structure — a 5-minute canonical-hand simulation would have caught this before parquet persistence.
5. **Smoke-train rank-<80 abort gate is insufficient.** v48's features cleared smoke at #51/#69/#73, improved at full scale to #43/#57/#68, but still yielded $2/1000h overall. Future smoke gates should add a per-category prefix mini-grade (5K-hand sub-grid for target category) to test signal *materialization*, not just feature *usage*.
...
7. **Compute efficiency lesson — Full train at 4.8M rows is now ~10 min, not 30.** v48's 578s wall vs v44's historical ~30 min suggests sklearn DT fitting is benefiting from caching/JIT effects after multiple v40+ retrains. Worth noting for any future v49+ capacity planning.
...
- Two-track divergence: $348/1000h.
- Project rule count: 18.
- Decision 113: v48_dt CLEAN NULL ship; **single-model ML feature-engineering track formally CLOSED at v44 regime.** Path forward priority: (1) Option D rule-chain extension on S77 LOW pair kicker_max-in-pair-suit discriminator (operates outside DT saturation); (2) fresh cross-product diagnostic on two_pair/trips STRUCTURE; (3) Option A oracle-label N=1000 re-eval (gated on cluster access).

**Session 79 priorities (per CURRENT_PHASE.md S78 rewrite):**
1. **PHASE 1 (~30 min):** Re-read S77 drill outputs; confirm kicker_max-in-pair-suit discriminator (70% TRUE in LOW × PBOT_DS_PARTIAL vs 32-34% in LOW × PMID-target cells) and the SPLIT_tmax_SS_mu → PMID_tmax_DS mismatch class (n=3,072, $10.97/1000h).
2. **PHASE 2 (~45 min):** Design Rule 19 candidate: trigger = single-pair AND pair_rank ∈ {2..7} AND kicker_max NOT in pair_suits AND n_PMID_DS_w_maxtop ≥ 1. Action = force PMID_tmax_DS routing. Expected ~$15-22 within-cell residual capture; full-grid ≈ $5-8.
3. **PHASE 3 (~15 min):** Grader-confirm v57 (rule 19 + v56) vs v56 baseline. Apply +$10 ship bar.
4. **PHASE 4 (~20 min):** If Rule 19 NULLs, pivot to fresh two_pair / trips cross-product diagnostic mirroring S77's drill structure.
...
> **End of Session 96 (2026-05-16) — Sprint 8 ACTIVE.** DOCUMENTATION-ONLY SESSION. Production UNCHANGED: **v65_mid_pair_chain_extend remains production at $1,633.79/1000h full / $776.88 prefix**; v44_dt remains ML champion ($1,081/$686; **24 sessions unchanged** since S58); rule count 25 (UNCHANGED). **Headline-goal recalibration: 95% match-rate / agreement target formally retired second-stage (Decision 131); $/1000h on the production grid codified as the project's headline metric.** S96 closed a multi-session loop dating to Decision 033 (S16, 2026-04-27) which had retired the *shape-agreement* form of the 95% target but never executed its Consequence #1 ("CLAUDE.md update deferred to S17"); the *match%* form survived in load-bearing docs and re-emerged as a zombie target through ~30 subsequent sessions of saturation evidence accumulating. Phase A audit found three load-bearing zombie-95% references (CLAUDE.md:12, CLAUDE.md:20, checklist.md:159) + one Phase 4 description (SPRINT_INDEX.md:49); all updated. Phase B drafted the replacement headline: PRIMARY = production strategy $/1000h on the full grid (currently $1,633.79); SECONDARY (diagnostic) = remaining gap to oracle ceiling ($111.41), two-track divergence ($552.79), rule count (25); operational pre-committed two-grid SHIP standard at $5/1000h both grids UNCHANGED. Phase C applied edits: CLAUDE.md (lines 12 + 20 rewritten; Decisions-033+131 pointer paragraph added under Primary Goal), checklist.md (lines 158-159 struck through with decision pointers), STRATEGY_GUIDE.md (front-matter "Last updated" stanza prepended for S96; Part 1 Session 96 entry appended), CURRENT_PHASE.md (rewritten for S97), DECISIONS_LOG.md (Decision 131 appended), SESSION_96_REPORT.md (NEW), MASTER_HANDOFF_01.md (this entry), sprints/SPRINT_INDEX.md (S96 entry appended; Phase 4 description updated). **NO code touched. NO engine runs. NO grader runs.** Saturation closures cited in Decision 131: Decision 113 (ML feature engineering at v44 capacity); Decision 117 (A-path label quality at v44 capacity); Decisions 122-127 (chain-audit COMPLETE, $214.83/1000h shipped + 2 NULLs at boundaries); Decision 129 (rule-extraction bucket-level SATURATED at $5.08/1000h ceiling); Decision 130 (rule-extraction intra-layout SATURATED on strongest candidate trips B_DS_AVAIL_LKR MIXED at $4.59/$4.75 — $0.25 short of $5 SHIP bar). Plus S79's empirical finding: oracle labels self-disagree at 32% N=200↔N=1000 — any match% above ~68% on N=200 oracle is partially memorizing label noise; v44 sits at 67% on N=1000 Lens-3 OOS; the 95% target was set before this measurement. Match% retained as diagnostic only — still useful for debugging, comparable across sessions, but not the headline. NEW S96 methodology lessons: (1) **doc drift compounds across sessions** — Decision 033 deferred a CLAUDE.md update as "not blocking" → never done across 79 sessions; periodic audits of load-bearing headlines catch zombie targets cheaply (~1 session of grep + careful editing); (2) **headline-goal recalibration is a one-off** — three saturation closures across major levers form the legitimate evidentiary trigger, not a single NULL session; the per-candidate $5/1000h SHIP standard is unchanged so this is not "lowering the bar to ship", it is "calling the finish-line where the evidence already pointed"; (3) **$/1000h survives label noise where match% does not** — match% on an oracle with 32% self-disagreement is fundamentally noisy as a per-hand metric; $/1000h averaged across 6M × 105 × N is robust by CLT; pick a metric that the data quality supports. Combined S87-S93 production-chain recovery still $221.26/1000h (S94 + S95 + S96 contribute $0). Two-track divergence UNCHANGED at $111.41/1000h; cumulative closure UNCHANGED at 92.09%. All remaining open levers (A3 ML retrain, v52-DL exploit, v44_RULE13 replacement) require either operator authorization (A3, ~70h wall, credibility-low expected outcome) or are speculative/lower-magnitude. S97 PRIMARY: A3 ML retrain. S97 SECONDARY: v52-defensive-low partial-effectiveness exploit. S97 TERTIARY: v44_RULE13 fallthrough replacement. S97 MAINTENANCE option: re-evaluate parked MIXED candidates (v60 gate-11 at +$4.85/+$4.77, S95 NARROW gate at +$4.59/+$4.75) as composite-rule joint ship candidates. See CURRENT_PHASE.md for the Session 97 resume prompt.

> **End of Session 97 (2026-05-16) — Sprint 8 ACTIVE.** STRATEGY OF RECORD UNCHANGED: **v65_mid_pair_chain_extend remains production at $1,633.79/1000h full / $776.88 prefix.** v44_dt remains ML champion ($1,081/$686; **25 sessions unchanged** since S58). Rule count 25 (UNCHANGED). **S97 executed the S96 MAINTENANCE option (re-evaluate parked MIXED candidates as composite ship) and closed it as STRUCTURAL NULL via Decision 132.** Phase A relocated both candidates: `strategy_v60_mid_pair_ds_nomaxtop.py` defaults to `make_strategy_v60(max_sing_gate=11)`; `strategy_v66_trips_layout_a_force_ds_bot.py` defaults to NARROW gate. Phase B identified a structural concern BEFORE any code ran: v60-gate11 fires on `max_sing ≤ J` while v65 already ships v60-gate12 firing on `max_sing ≤ Q` with **byte-identical picker** (`_detect_mid_pair_defensive_pmid_swap`). Gate=11's firing zone is a strict subset of gate=12's. The S93 SECONDARY's "+$4.85 N=200 / +$4.77 N=1000" was measured against the **v57 baseline** (pre-Rule-25), not against current production v65. Phase C built `analysis/scripts/spot_check_v60g11_subset_v65_S97.py`: loaded `data/session93/v60_per_hand_picks.npz`, identified 14,160 gate-11 firing hands, decoded each via `canonical_hands.bin`, computed `strategy_v65_mid_pair_chain_extend(hand)`. **Result: 14,160 / 14,160 = 100.0000% v65_pick == v60_gate11_pick; zero hands fall through to v57; v60-gate11 is fully absorbed by v65 on its firing zone; incremental lift over v65 = $0.** Wall time: 3.4s on a single core. Phase D: the composite hypothesis reduces to v66-NARROW alone, which is locked MIXED at $+4.59 N=200 / $+4.75 N=1000 (S95 cached grading, `data/session95/grade_v66_n1000_summary.json`) — $0.25 short of the $5 SHIP bar on each grid. No re-grade required; v66-NARROW vs v65 unchanged since S95. Phase E: Decision 132 closes the maintenance lever as STRUCTURAL NULL. v60-gate11 removed from "open candidates" list. v66-NARROW characterization unchanged. **No code change to any strategy script or engine. No grader run.** New artifacts: `analysis/scripts/spot_check_v60g11_subset_v65_S97.py`, `data/session97/spot_check_v60g11_subset_v65.json`, `SESSION_97_REPORT.md`. NEW S97 methodology lessons: (1) **PARKED-CANDIDATE BOOK-KEEPING MUST RECORD BASELINE + RE-GRADE BEFORE COMPOSITE HYPOTHESES** — a "+$X lift" is baseline-relative; once a related candidate from the same cell ships, +$X becomes double-counted relative to current production. v60-gate11's +$4.85 was true vs v57 but became stale once Rule 25 (= gate=12) shipped because gate=11 ⊂ gate=12. Future parked-candidate annotations must record (a) the baseline strategy and (b) a re-grade-against-current-production check before any composite hypothesis. Decision 131's lesson was zombie *headline* framing; this is zombie *candidate* framing. (2) **STRUCTURAL SUBSET CHECKS ARE CHEAP AND DECISIVE** — cells like `max_sing ≤ J` ⊂ `max_sing ≤ Q` are immediately testable on the per-hand picks NPZ already existing; ~5 min code + 3.4s compute resolved the question. If the structural relationship had been checked at S93 SECONDARY framing time, the candidate wouldn't have been carried as "open" for 4 sessions. Combined S87-S93 production-chain recovery still $221.26/1000h (S94 + S95 + S96 + S97 contribute $0). Two-track divergence UNCHANGED at $111.41/1000h; cumulative closure UNCHANGED at 92.09%. **MAINTENANCE LEVER CLOSED (Decision 132).** All open levers now characterized: chain-audit (Decision 127), rule-extraction bucket-level (Decision 129), rule-extraction intra-layout (Decision 130), headline-goal recalibration (Decision 131), maintenance composite (Decision 132). Remaining open: A3 ML retrain (operator-authorization-gated, ~70h wall, honest NULL prior), v52-DL exploit (speculative), v44_RULE13 replacement (modest at best). S98 PRIMARY: A3 ML retrain. S98 SECONDARY: v52-defensive-low partial-effectiveness exploit. S98 TERTIARY: v44_RULE13 fallthrough replacement. MAINTENANCE option: CLOSED. See CURRENT_PHASE.md for the Session 98 resume prompt.
