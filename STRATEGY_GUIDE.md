...
- **Combined chain (12 rules, CURRENT PRODUCTION)** → `analysis/scripts/strategy_v43_rule12_two_pair_DS_intact.py` (wraps v42 with Rule 12 — J-low two_pair both-intact + DS-bot via HH-to-bot tie-break with LL-to-bot fallback)
