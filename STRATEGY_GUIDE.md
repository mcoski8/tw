...
## Session 54: v39_dt new ML champion via diagnostic-driven feature engineering — LARGEST ML retrain ship in project history (+$237 full / +$90 prefix)
...
| **v39_dt** | **S54** | **36** | **1** | **87 (83 + 4 pair_aug_v5 rank-valued)** | **1,518,368** | **$1,412** | **$801** | **CURRENT ML CHAMPION — LARGEST ML RETRAIN SHIP IN PROJECT HISTORY**. +43% leaves over v36, depth saturation broke from 33 to 36, 3 of 4 features in top-30 importance. pct_opt full 53.61% → 57.88% (+4.27%, largest ML jump since v34). pair zone within-category $1,604 → $1,097 (−$507, −32%); other categories byte-identical (gated). Lift: −$237 full / −$90 prefix. Cumulative v32 → v39 = −$303 full. Methodology breakthrough: rank-valued conditional features that describe the QUALITY of the alternative configuration unlock saturated trees. |
