...
>
> **Production rule chain (end of Session 87): v61_high_only_ds_no_joint_fix** —
> stacks atop v57 with a single gate-out trigger (Rule 21): for HIGH_ONLY
> (no-pair) hands with max ∈ {J,Q,K,A} in the DS_NO_JOINT cell, bypass
> the v47→v48→v52 chain and return strategy_v44_dt directly. Else route
> to v57_lo_pair_defensive (which adds Rule 20 atop v56 etc.). Score:
> **$1,511.20/1000h full grid / $776.88 prefix** (prefix unchanged — the
> rule fires entirely outside prefix coverage) — beats v14 by
> **+$2,350/1000h** on the full grid. Lives at
> `analysis/scripts/strategy_v61_high_only_ds_no_joint_fix.py`. **Total
> project rule count: 21** (Rule 21 added in S87 — chain gate-out fix
> for the $98/1000h v52-chain bleed on weak-hand DS_NO_JOINT cells).
> S87 is the second strategy-of-record change in 5 sessions (S83 added
> Rule 20).
>
