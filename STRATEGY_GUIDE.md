...
- **Combined chain (11 rules, CURRENT PRODUCTION)** → `analysis/scripts/strategy_v42_rule11_jpair_pbot_ds.py` (wraps v41 with Rule 11 — J-pair pair-to-bot DS, surgical override at the J-pair-J cell when DS-bot achievable with pair in bot)
