...
>
> Last updated: 2026-05-13 (Session 77 — **DIAGNOSTIC SHIP / NO STRATEGY OF RECORD CHANGED: pair-first deep-drill identifies LOW pair (rank 2-7) as carrier of 74.6% of pair's STRUCTURE leak ($86.54 of $116.04/1000h); 5 LOW PMID/PBOT cells carry $84.56/1000h with a single dominant mismatch pattern (v44 over-routes LOW pairs to SPLIT/PBOT, oracle keeps PMID); three feature hypotheses H6/H7/H8 queued for S78 v48_dt retrain**. `drill_v44_pair_S77.py` swept all 2,800,512 pair hands (10.2 min wall, 4,500 hands/sec) applying the combined (pair_rank_tier × S66 cell × setting-rank bucket) lens — the genuinely new diagnostic: S66 introduced the 6-cell pair taxonomy (PBOT_DS_JOINT/PBOT_DS_PARTIAL/PMID_DS_MAXTOP/PMID_DS_NOMAXTOP/PMID_SS_MAXTOP/PMID_OTHER) and S71 introduced the setting-rank NOISE/MID/STRUCTURE buckets, but neither applied the OTHER's lens. Total pair WG $511.16/1000h reconstituted exactly. **Top 5 STRUCTURE-bucket cells (all LOW tier):** LOW × PMID_DS_NOMAXTOP $31.00 (11,884 hands, gap_2nd 0.18), LOW × PMID_DS_MAXTOP $21.68 (6,760 hands, gap_2nd **0.385 — sharpest in project**), LOW × PMID_OTHER $11.81 (5,355 hands), LOW × PBOT_DS_PARTIAL $10.36 (7,977 hands, REVERSE-direction cell), LOW × PMID_SS_MAXTOP $9.71 (4,484 hands). Sum: 36,460 hands × $84.56/1000h. **Single largest mismatch class** `SPLIT_tmax_SS_mu → PMID_tmax_DS` in LOW × PMID_DS_MAXTOP: n=3,072 × $21,459 mean regret = $10.97/1000h on ONE class out of pair's $116 STR total. **Three feature hypotheses queued** for S78 v48_dt retrain at depth=36 ml=1 (S73 regime LOCKED): H6 (`pair_pmid_ds_n_configs_g`, int8 0..5, single-pair gated, expected $7-12/1000h full-grid), H7 (`pair_kicker_max_in_pair_suit_g`, bool 0/1, single-pair gated, expected $5-10/1000h full-grid), H8 (`pair_low_pmid_safety_g`, int8 0..5, LOW-pair-only gated, expected $10-17/1000h full-grid). Joint H6+H7+H8 expected lift (50% redundancy budget): $14-22/1000h full-grid — clears the +$10 ship bar with moderate margin. **Reverse-direction caveat:** LOW × PBOT_DS_PARTIAL cell is where v44 should route to PBOT (not PMID); H8 alone would push it wrong way; H6+H7 must let DT learn kicker_max-alignment discriminator (70% TRUE in PBOT_DS_PARTIAL vs 32-34% in PMID-target cells). Decision 112 records the diagnostic findings + H6/H7/H8 plan. **Production state UNCHANGED for the SIXTH consecutive session** (S72 NULL, S73 PARTIAL/NULL ship, S74 clean NULL, S75 boosting NULL, S76 diagnostic ship, S77 diagnostic ship); v44_dt remains ML champion at $1,081 full / $686 prefix, v56_trips_hybrid remains rule chain at $1,429 full / $794 prefix. Two-track divergence $348/1000h unchanged. Project rule count 18 unchanged. **Seven methodology lessons:** (i) S71×S66 product lens is a portable diagnostic; ~10 min wall for 2.8M pair hands at 4,500 hands/sec; (ii) tier-collapse is a powerful first-cut — LOW pair carries 3× more closeable signal density than HIGH; (iii) gap_2nd × bucket × cell intersection is the cleanest target-confidence metric — LOW × PMID_DS_MAXTOP STR-bucket gap_2nd_med 0.385 is the sharpest cell observed in S76/S77; (iv) a single mismatch class can carry 10% of a category's STRUCTURE leak ($10.97 out of $116) — has unusually high expected lift but also unusually high redundancy risk; (v) reverse-direction mismatch cells exist within a category's leak (LOW × PBOT_DS_PARTIAL is exception); (vi) "Speed is not necessary — clarity and perfection is" — S77 spent 30 min PHASE 1+2 + 20 min PHASE 3 producing a data-supported feature pack; (vii) +$10 ship bar canonical (S73 codified, held S74-S77). PAIR_S77_FEATURE_HYPOTHESES.md captures full hypothesis definitions, derivation arguments, redundancy risk assessments. SESSION_76_DIAGNOSTIC_REPORT.md (S76) remains the canonical cross-category diagnostic record. Earlier: Session 76 — **DIAGNOSTIC SHIP / NO STRATEGY OF RECORD CHANGED: cross-category setting-rank diagnostic identifies PAIR as the next ML/rule target ($116.04/1000h STRUCTURE-bucket leak, fresh territory); two_pair / three_pair / trips_pair empirically confirmed as noise-ceiling-limited (Option A candidates)**. `drill_v44_setting_rank_all_cats_S76.py` swept all 6,009,159 canonical hands (17.9 min wall) and partitioned each category's v44 leak into NOISE (rank 2-3) / MID (rank 4-9) / STRUCTURE (rank ≥10) buckets, with gap_2nd (optimum sharpness) and plateau width sampled per bucket. **Full-grid contribution decomposition** (sum reconstitutes v44's $1,081/1000h grade): pair $511.16 (STR $116, NOISE $207), high_only $381.39 (STR $148, NOISE $80), two_pair $80.82 (STR $0.86, NOISE $58), trips $65.18 (STR $13, NOISE $23), three_pair $30.70 (STR $0.78, NOISE $22), trips_pair $8.03 (STR $0.21, NOISE $5), composite $2.35 (STR $0.41, NOISE $0.57), quads $1.30 (STR $0.20, NOISE $0.40). Total STR-bucket $279.23 (25.8%) / NOISE-bucket $394.38 (36.5%) / MID-bucket $407.34 (37.7%). **Three findings:** (1) PAIR is the highest-leverage next target — never drilled with the setting-rank lens, sharp gap_2nd of 0.21 (sharper than high_only STR's 0.11), 59,355 hands in STR bucket, contributes 47% of v44's total full-grid leak. (2) two_pair / three_pair / trips_pair are noise-ceiling-limited (STR/TOT < 3% each; combined $83.55/1000h NOISE-bucket leak); Option A (oracle N=1000 re-eval) now empirically justified for these specifically. (3) high_only's STR leak ($147.59) is real but H1-H5 cascade exhausted; pair-first exploits cleaner residual signal. **S77 pivot: pair-first cell-taxonomy deep-drill** (analogous to drill_v44_high_only_S71.py for high_only). Decision 111 records the diagnostic findings + S77 recommendation. **Production state UNCHANGED for the FIFTH consecutive session** (S72 NULL, S73 PARTIAL/NULL ship, S74 clean NULL, S75 boosting NULL, S76 diagnostic ship); v44_dt remains ML champion at $1,081 full / $686 prefix, v56_trips_hybrid remains rule chain at $1,429 full / $794 prefix. Two-track divergence $348/1000h unchanged. Project rule count 18 unchanged. **Seven methodology lessons:** (i) category-agnostic setting-rank lens is portable — no per-category structural taxonomy needed for first-pass diagnostic; (ii) full-grid CONTRIBUTION ordering ≠ within-category $/1000h ordering (pair $511 > high_only $381 contribution; pair $1,097 < high_only $1,868 within-cat); (iii) STR/TOT ratio cleanly separates closeable-signal from noise-ceiling categories (>15% closeable; <5% noise-dominated); (iv) gap_2nd × bucket is the sharpness metric — sharp + STR = high-confidence feature-engineering target; (v) plateau width 1.0-1.2 at EPS_REL=0.5% confirms argmax well-isolated at N=200 — label noise lives in EV magnitude, not argmax determinacy; (vi) avoid the S57-S75 trap of sinking 12+ sessions into a diminishing-return category — re-check the cross-category lens after every 3 NULL/partial sessions on a single category; (vii) +$10 ship bar canonical (S73 codified, held S74-S76). SESSION_76_DIAGNOSTIC_REPORT.md captures the full retrospective + Appendix A pair-first justification. Earlier: Session 75 — **DECISIVE NULL: v47_xgb gradient boosting REGRESSES v44 by −$1,392/1000h full grid; entire single-model ML track exhausted at v44 saturating regime**. XGBoost 3.2 at depth=6, n_estimators=200, learning_rate=0.1, multi_strategy='multi_output_tree', subsample=0.7, colsample_bytree=0.7 trained on v44's exact 107 features (clean "boosting vs DT" isolation; ho_v7 deferred to v48_xgb iff v47_xgb ships). Fit 3h42m wall, val RMSE 1.37 → 0.534 over 200 iters. **Full grader: every category regresses uniformly** — high_only $1,868 → $3,461 (Δ −$1,593), pair $1,097 → $2,291 (Δ −$1,194), two_pair $363 → $1,845 (Δ −$1,482), trips $1,194 → $2,716 (Δ −$1,523), trips_pair $281 → $3,027 (Δ −$2,746), three_pair $1,613 → $2,069 (Δ −$456), quads $545 → $2,265 (Δ −$1,720), composite $960 → $3,351 (Δ −$2,392). Pct opt collapses 64.80% → 41.96% (−22.84pp). Prefix grader confirms −$765/1000h on 500K subset with 0 high_only IDs — regression on the 7 non-high_only categories alone. **Structural cause: capacity mismatch.** v44_dt has 2,248,173 leaves at 2.7 rows/leaf (essentially memorized lookup); v47_xgb at depth=6 × 200 trees has at most 64×200 = 12,800 distinct partition cells (175× fewer). Val-curve tripwire FIRED (last-50 Δ +0.011, best_iter=199/200) — model under-converged, but closing $1,392 gap by tuning alone implausible. **Inference speedup: v47_xgb predicts 6M-hand grid in 18.9s vs v44's 1,046s — 55× faster** (real but moot at this accuracy gap). Top-30 importance dominated by same v44 feature set (n_broadway 15.1%, n_low 10.2%, second_rank 6.0%, ho_v2_bot_DS_max_top_rank_g 4.2%). Decision 110 records NULL ship. **Production state UNCHANGED for the FOURTH consecutive session** (S72 NULL, S73 PARTIAL POSITIVE / NULL ship, S74 clean NULL, S75 decisive NULL); v44_dt remains ML champion, v56_trips_hybrid remains rule chain. Hypothesis cascade FINAL: H1 PARTIAL ($24 within-cat), H2 CLEAN NULL ($0), Option B DECISIVE NULL (−$1,392). Single-model ML track exhausted at v44 saturating regime — DT feature engineering AND moderate-capacity boosting both failed to clear +$10 ship bar. **S76 must pivot to a NEW track:** (A) oracle-label N=1000 re-evaluation (label-noise ceiling test), (B) categorical diagnostic refresh (new feature target), (C) higher-capacity boosting retry (~15-25h wall, speculative), or (D) rule-chain extension (residual $348 two-track divergence). Seven methodology lessons: (i) single deep DT beats shallow boosting for argmax-over-N tasks on saturating-memorization data — contradicts typical ML wisdom; (ii) val-curve tripwire is the boosting analog of DT leaf-growth tripwire; (iii) lr×n_est is a useful capacity budget proxy for boosting; (iv) inference speedup is a separate axis from accuracy and may justify capacity-matched retries even at parity; (v) boosting M-series Mac install needs libomp via Homebrew; (vi) single-model ML track exhausted — four consecutive NULL sessions confirm pivot mandatory; (vii) +$10 ship bar canonical and held — fourth UNCHANGED production session. SESSION_75_V47_XGB_NULL_REPORT.md captures the full retrospective. Earlier: Session 74 — **CLEAN NULL: v47_dt = v44 at +$0/1000h full grid; H2 route-tradeoff comparator (`ho_v7_route_tradeoff_joint_minus_nonjoint_g`, 1 signed int8 feature) captures zero signal at depth=36 ml=1; DT-feature-engineering track exhausted at v44 saturating regime; S75 pivots to gradient boosting (Option B)** — v44_dt remains ML champion, v56_trips_hybrid remains rule chain. v47_dt full grade: $1,081/1000h vs v44 $1,081/1000h, all 8 per-category $/1000h match v44 to the dollar (including on-target high_only $1,868 → $1,868 — zero within-cat lift; v46b earned +$24 within-cat with H1 at the same regime). pct_opt 64.80% → 64.80% (3-hand divergence of 6M, +0.00005pp). Prefix grade byte-identical at $686. Both tripwires concur NULL: feature importance #103/108 (0.01%) — deeper than v46b's #75; leaf growth **+1 vs v44's 2,248,173** — cleanest "dead feature" signature in project history (vs v45's +9 NULL, v46b's +12,354 SHIP-but-PARTIAL). Training fit 567s vs v46b's 610s at same regime — faster fit confirms DT scarcely used the new feature. **S71's "derivable in 2 splits" trap empirically confirmed**: at depth=36 with 2.25M leaves at 2.7 rows/leaf, the DT can derive the comparator (best_JOINT_mid_high − best_DS_NONJOINT_top) from ho_v3 max_mid_high + a near-relative of ho_v4 topNonMax_DS_ms_max_top_rank via axis-aligned splits. The +1 leaf delta is the empirical fingerprint of "comparator compresses zero new information beyond 2 existing splits". The 84.27% of hands at value 0 (gated or no DS achievable) and the all-non-positive distribution (15.73% at -14..-1; zero positives) confirm the design-stage structural analysis. Decision 109 records the NULL + S75 pivot direction. Six methodology lessons: (i) both tripwires concur NULL at +1 leaf + tail importance = new cleanest dead-feature signal; (ii) "derivable in N splits" is now a documented failure mode — verify non-derivability before retrain investment; (iii) fitter wall time is a 3rd tripwire — faster fit at same regime = NULL signal; (iv) diagnostic-WG recovery cascade is H1 16% then H2 0% — single-feature retrains capture ~10-20% then asymptote; (v) DT-feature-engineering chapter functionally closed at v44's saturating regime — two consecutive sessions (S73 PARTIAL, S74 NULL) at same 4-phase playbook produce diminishing returns; (vi) +$10 ship bar canonical (codified S73, held S74) — third consecutive UNCHANGED production state. S75 prescription: gradient boosting (XGBoost ≥2.0 multi-output, OR LightGBM MultiOutputRegressor) on v44's 107 features alone, isolating "boosting vs single-tree DT" as the only variable; defer H1/H2 features to v48_xgb if v47_xgb ships. SESSION_74_V47_DT_NULL_REPORT.md captures the full story. Earlier: Session 73 — **PARTIAL POSITIVE / NULL ship: v46b_dt lifts v44 by +$5/1000h full grid at depth=36 ml=1 (below +$10 ship threshold); no strategy of record change** — v44_dt remains ML champion, v56_trips_hybrid remains rule chain. S72's v46_dt was −$256/1000h full at depth=32 ml=3; S73 retrained the **same 109 features** at v44's saturating regime (depth=36 ml=1) to isolate feature effect from regime effect. **Result: v46b at $1,076/1000h vs v44 at $1,081/1000h = +$5/1000h full**, +0.12pp pct_opt; within-cat high_only $1,868 → $1,844 (−$24 better, +0.7pp pct_opt); 7 of 8 non-high_only categories byte-identical to v44 — surgical gating PERFECT. Leaves +12,354 (2.25M → 2.26M). Feature importance: #75 (0.05%) and #105 (0.01%) — both deep in tail. **Regime-confound theory CONFIRMED**: $261/1000h v46→v46b swing entirely from hyperparameters (feature set held identical). User (asked) confirmed adherence to +$10 ship bar — at +$5, v46b is strictly-better but below threshold; Decision 108 records PARTIAL POSITIVE / NULL ship. H1 (SS+ms route quality) captured 16% of S71's $147.59 WG diagnostic prediction — calibration lesson: diagnostic identifies WHERE leak is, not the magnitude recoverable per single-feature-pair retrain. **S74 pivots to H2 (route-tradeoff comparator `ho_v7_route_tradeoff_joint_minus_nonjoint_g`) per SESSION_71_V45_FEATURE_HYPOTHESES.md §6** at depth=36 ml=1 (regime locked); secondary pivot is gradient boosting (XGBoost/LightGBM) if H2 also lands sub-threshold. Five methodology lessons: (i) regime-confound is the dominant axis of NULL postmortems — never change features AND hyperparams in same experiment; (ii) surgical gating's byte-identity guarantee is regime-locked; (iii) feature importance > leaf growth as tripwire at saturating regime; (iv) diagnostic WG is ~10-20% recoverable per single-pair feature retrain; (v) +$10 ship threshold codified — ML-champion ships hold to +$10 regardless of within-cat magnitude or strictly-better gating math. S72 v46_dt full grader completed retroactively in S73 (was TCC-blocked): v46 $1,337 vs v44 $1,081 = −$256/1000h, broad-based regression including +$251 on on-target high_only. Earlier: Session 72 — **NULL RESULT: v46_dt LOSES to v44_dt by −$32/1000h on prefix grid at depth=32 ml=3; no strategy of record change** — v44_dt remains ML champion, v56_trips_hybrid remains rule chain. S71's setting-rank diagnostic identified $147.59 WG of STRUCTURE-bucket leak with `SS_mu → SS_ms` as dominant mismatch family; S72 implemented H1 (2 ho_v6 features: `topMax_SS_ms_n_configs_g`, `topMax_SS_ms_max_mid_high_g` — direct SS-axis counterpart to ho_v3's DS-axis pair that shipped +$79 in S57) and trained v46_dt at the project-default regime depth=32 ml=3 (deliberate change from v44/v45's depth=36 ml=1 saturated regime). **Result: NULL.** ho_v6 features ranked #79 (0.03%) and #105 (0.01%) of 109 features; leaf count collapsed 51% (2.25M → 1.10M) under the regime change. Prefix grader: v44 $686 → v46 $718 (+$32 worse), pct_opt 67.13% → 66.63% (−0.50pp); per-cat regression broad-based (two_pair +$66, trips +$30, trips_pair +$183, composite +$156 worse). **Regime-confound NOT YET disentangled** — v46b_dt at depth=36 ml=1 (v44's saturating regime) queued for S73 to isolate feature effect from regime effect. Repo physically relocated mid-session from `~/Documents/claudecode/taiwanese/` to `~/CODE/taiwanese/` to dodge macOS TCC `com.apple.provenance` blocks on the Documents folder; git remote unchanged. Full grader DEFERRED (was blocked by TCC; queued for S73 alongside v46b training). Decision 107 documents the NULL + S73 plan. SESSION_72_V46_DT_NULL_REPORT.md captures the full story. **The 4-phase playbook gains a 5th phase: regime-isolation retry.** When changing hyperparams AND feature set in the same run, NULL results are uninterpretable; the fix is a single-variable retry at the prior model's hyperparams. Earlier: Session 71 — **DIAGNOSTIC + FEATURE ENGINEERING session; NO strategy of record change** — v44_dt remains ML champion, v56_trips_hybrid remains rule chain. Phase 1a: `drill_v44_high_only_S71.py` introduced setting-rank diagnostic lens (MATCH/NOISE/MID/STRUCTURE partition) on v44's high_only residual; finding: $147.59 WG (38.7% of high_only's $381.39) is STRUCTURE-bucket (rank ≥10 in oracle's sorted-EV list), concentrated at K/Q/J/T max-ranks in DS_NO_JOINT cells — testable feature-engineering headroom, NOT pure oracle-noise leak. Phase 1b: `SESSION_71_V45_FEATURE_HYPOTHESES.md` documents 5 hypotheses (H1-H5); H1 (SS+ms route quality) selected — direct SS-axis counterpart to ho_v3's DS-axis pair (which shipped +$79 in S57). Phase 2: `high_only_aug_v6_features_gated.py` implements 2 new features (`topMax_SS_ms_n_configs_g`, `topMax_SS_ms_max_mid_high_g`); smoke-tested on 5 hand-crafted cases. `persist_high_only_aug_v6_gated.py` ready for S72 invocation. v44 has ZERO SS+ms enumeration features (clean non-derivability story for H1). S72 will train v46_dt at depth=32 ml=3 (project default; deliberate regime change from v44/v45's depth=36 ml=1 saturation regime). Predicted ship range $30-80 WG full-grid via v54+v55+v56 hybrid chain compounding. NULL fallback: depth=36 ml=1 retry, then pivot to gradient boosting or grid label N=1000 re-evaluation. **The setting-rank lens is reusable; can be applied to pair/two_pair/trips in future sessions.** v45_dt (S59 NULL) preserved as historical record; next attempt is v46_dt to preserve naming chain. Decision 106 documents the diagnostic + plan in DECISIONS_LOG.md. Earlier: Session 70 — **v56 trips hybrid SHIPS — third consecutive Path-B hybrid ship; closes trips category at v44 limits (+$45/1000h full grid; +$33 prefix)**. Path B (blanket trips → v44_dt) captured the $44.61 WG matrix-predicted v55→v44 trips gap. Grader: v55 $1,473 → v56 $1,429 full / $827 → $794 prefix; pct_opt 58.44% → 59.51% (+1.07pp); within-trips $2,010 → $1,194 (−$816); within-trips pct_opt 39.0% → 58.6% (+19.6pp). All non-trips categories byte-identical (surgical via trips-blanket gate). Two-track divergence v56 vs v44_dt: $393 → **$348** (closed 11% in S70). Cumulative S68+S69+S70 closed $1,061/1000h = **75% of original $1,409 divergence**. Three-gate hybrid chain (pair-PBOT in v54 + two_pair in v55 + trips in v56) is now the project's cleanest architecture — structurally disjoint at the rank-count signature level. v56 routes ~40% of canonical grid through v44_dt. Routing gate: exactly_one_trip AND no_pairs AND no_quads → v44_dt; else → v55. Harness `validate_v56_routing_S70.py` reused existing parquet to predict +$44.61/1000h; grader returned +$45 — **0.87% error, well within reliable predictive range**. Per-cell breakdown: B_DS_AVAIL_LKR +$25.50 (largest), NO_BDS_AKDOM +$15.57, NO_BDS_CTOP +$2.70, B_DS_AVAIL_HKR +$0.84 (near-tie). Counter-headroom $0.76 WG at B_DS_AVAIL_HKR ranks {K,J,T,4,3} forfeited in blanket; net $44.61. Phase 3a tested 3 catalog candidates: **0 of 4 cleared T1 vs v55 baseline; 3 of 4 actually LOSE to v55** (rule worse than baseline) — EVEN MORE DOMINATED than S69's pattern. **Trips catalog CLOSED** (v56 EQUALS v44 since the gate is total). Combined with high_only S65 + pair S68 + two_pair S69 closures, the FOUR largest residual categories (5.69M of 6.01M canonical hands = **94.7% of grid**) are now ALL addressed at the limits achievable by current rule chain + v44_dt. **Architectural-routing headroom is largely exhausted; S71+ pivots to ML retrain (v45_dt+) — any v44 improvement compounds 4× via v54+v55+v56.** Six methodology lessons: (i) the Path-B hybrid arc generalizes to small categories with consistent fidelity — $382/$634/$45 ships at 0.1%/0.07%/0.87% error; (ii) catalog candidates can be MORE dominated as v44 gets selective on smaller categories — S70 0/4 cleared T1 vs S69's 3/5 cleared T2; (iii) the three-gate hybrid chain is the project's cleanest architecture; (iv) the architectural-routing headroom is largely exhausted — remaining catalog targets ship <$10 WG each predicted; (v) smaller ships still close categories — closure ≠ size; (vi) methodology arcs compress to ~1 session per category once templates are in place. **S71+ pivots to ML retrain (v45_dt+) — high_only diagnostic-driven feature engineering targeting the $755 WG remaining v44 residual on the largest single category (12.6% of grid)**. Earlier: Session 69 — **v55 two_pair hybrid SHIPS — NEW LARGEST single production ship in project history (+$634/1000h full grid; 1.66× S68's prior $382 record)**. Path B (blanket two_pair → v44_dt) captured the entire $634 WG matrix-predicted v54→v44 two_pair gap. Grader: v54 $2,108 → v55 $1,473 full / $1,343 → $827 prefix; pct_opt 49.74% → 58.44% (+8.70pp); within-two_pair $3,211 → $363 (−$2,848); within-two_pair pct_opt 44.1% → 83.2% (+39.1pp). All non-two_pair categories byte-identical (surgical via two_pair-blanket gate). Two-track divergence v55 vs v44_dt: $1,027 → **$393** (closed 62% in one ship — largest single-session reduction in project history). Cumulative S68+S69 closed $1,016/1000h = 72% of original divergence. Routing gate: n_pairs == 2 AND no_trips AND no_quads → v44_dt; else → v54. Even simpler than v54's pair gate (no suit-pattern checks needed). Harness `validate_v55_routing_S69.py` reused existing parquet to predict +$634.47/1000h; grader returned +$634 — **0.07% error, cleanest match in project history**. Per-cell breakdown: LAYOUT_A_DS +$261.40 (largest), LAYOUT_A_SS +$186.15, LAYOUT_C_DS +$86.95, LAYOUT_B_DS +$63.78, LAYOUT_C_SS_ONLY +$29.42, LAYOUT_B_SS_ONLY +$6.78. Top 4 hi_pair_ranks (A, K, Q, J) account for 69% of lift. Phase 3a tested 5 catalog candidates: 3 of 5 cleared T2 vs v54 baseline but ALL lost to v44 ceiling (capture vs_v44 negative everywhere) — **a T2 verdict against the rule baseline is no longer sufficient evidence to ship a rule when the hybrid option exists**. **Two_pair catalog CLOSED** (v55 EQUALS v44 since the gate is total). Combined with high_only S65 + pair S68 closures, the THREE largest residual categories (5.36M of 6.01M canonical hands = **89% of grid**) are now ALL addressed. Records: largest single ship (+$634 vs prior $382); largest pct_opt jump (+8.70pp); cleanest harness fidelity (0.07%); largest single-session divergence reduction (-$634/1000h). Six methodology lessons: (i) Path-B hybrid arc compresses dramatically with reuse — pair took 3 sessions, two_pair took 1 by reusing all S66-S68 templates; (ii) catalog T2 verdicts vs rule baseline are NOT enough to ship when hybrid exists — always test "lift vs v44"; (iii) cleaner gates ship cleaner — v55's structural-category gate hit 0.07% vs v54's 0.1%; (iv) architectural moves dwarf rule-tuning ships (S68+S69 = $1,016 vs S43-S67 max single rule $131); (v) two_pair was structurally PURER ML-only than pair — no PMID-cell counter-headroom, hybrid simplifies to blanket category routing; (vi) records compound across sessions when architecture matches. **S70 pivots to trips audit ($110 WG residual; cleanest structural axes)**. Earlier: Session 68 — **v54 hybrid chain SHIPS — LARGEST single production ship in project history (+$382/1000h full grid)**. Path B (cell-routed: v44_dt on pair PBOT cells, v53 elsewhere) captured the entire $382 WG v52→v44 pair-PBOT gap that S67's 12 catalog-blanket-rule candidates couldn't realize. Grader: v53 $2,490 → v54 $2,108 full / $1,522 → $1,343 prefix; pct_opt 43.43% → 49.74% (+6.31pp); within-pair $1,811 → $991 (−$820). All non-pair categories byte-identical (surgical via single-pair-with-PBOT-DS gate). Two-track divergence v54 vs v44_dt: $1,409 → $1,027 (closed 27% in a single session). Routing gate: single-pair AND pair-suits-distinct AND ≥1 non-pair singleton of each pair-suit → v44_dt; else → v53. The gate is equivalent to "cell ∈ {PBOT_DS_JOINT, PBOT_DS_PARTIAL}" but doesn't require full cell-taxonomy machinery. Harness `validate_v54_routing_S68.py` pre-predicted +$382.34/1000h (PBOT cells +$382.34, PMID cells $0.00 — zero spillover); grader returned +$382 — 0.1% error, cleanest match in S60+ history. Per-cell highlights: Q-pair × PBOT_DS_PARTIAL = +$41.20 (exact match to matrix-predicted ceiling); K-pair total +$35.60 (matches C_PAIR_1 ceiling). Fire rate 27.7% of pair = 12.9% of canonical grid. v54 SUBSUMES Rule 19 (S67) because v44 catches more than Rule 19 in Q-pair × PBOT_DS_JOINT. Records: largest single ship (+$382 vs prior $131); largest pct_opt jump (+6.31pp); first Path-B hybrid ship. **Pair catalog CLOSED** (v54 within $50 WG of v44-alone). Combined with S65's high_only closure, the two largest categories (4M of 6M = 67% of grid) are now both addressed. Five methodology lessons: (i) catalog → matrix → falsification → hybrid arc is a replicable 3-session methodology; (ii) matrix predictions are accurate when mechanism matches but "catalog-shippable" framing was wrong because blanket rules couldn't realize it; (iii) harness-to-grader fidelity at routing layer is best-of-project (0.1% error); (iv) records are set by architecture not individual rules; (v) two_pair is S69's PRIMARY target ($920 WG residual). Earlier: Session 67 — **Rule 19 (Q-pair JOINT PBOT-DS) SHIPS as v53 — first rule chain ship since S53 v52 (six months wall-clock); grader-confirmed +$9/1000h full grid ($2,498 → $2,490); pct_opt 43.34% → 43.43%; prefix unchanged at $1,522 (Q-pair JOINT outside prefix-500K). Twelve C_PAIR_3 and C_PAIR_5 candidates tested via new `test_rule_catalog_pair.py` harness (validated against Rule 11's Decision 079 +$6 ship to 3.5% error); 11 of 12 are T3 net-negative. The PAIR_DECISION_MATRIX.md "$391 WG catalog-shippable PBOT-cell headroom" claim is decisively falsified — only $9/1000h (= 2.3% of $391) is actually catalog-shippable; the remaining gap is v44's *selective* gating, NOT realizable by blanket rules. Pair PBOT-routing on 12 of 13 pair_ranks is ML-only at catalog granularity (mirroring high_only S60-S64). Only Q-pair × PBOT_DS_JOINT cell admits a clean rule (oracle PBOT preference 53% peak; rule pct_opt 49.86% vs v52's 31.95% within-cell; capture +52.85%). Rule 19 design: pair_rank=Q AND JOINT PBOT-DS achievable → take max sing on top + ms mid + DS bot. Non-targeted regression on full pair category: zero spillover (rule fires only on 28,512 Q-pair JOINT hands; 0 fires across 77 other (rank, cell) combos). All non-pair categories byte-identical (surgical via pair gate). p90 0.720→0.715; p99 1.645→1.640. Two-track divergence: v53 vs v44_dt $1,409. Three methodology lessons: (i) per-category matrix doc ceilings OVERSTATE realizable rule lift — typically <5% of capacity (high_only <0%, pair 2.3%); (ii) selectivity is the catalog-shippable boundary — when rule_pct_opt is <50% within a cell, blanket-route rules will regress; (iii) the catalog audit methodology is a powerful filter — 78 candidates tested across S60-S67, with 77 falsified before commit. **S68 pivots to Path B (hybrid chain: v52-PMID + v44-PBOT cell routing) — expected $200-390 WG capture per PAIR_DECISION_MATRIX.md Recommendation Path B; reuses pair cell taxonomy + `_enumerate_pbot_ds` helper.** Earlier: Sessions 62-66 — high_only catalog closure (S62-S65, all NULL; HIGH_ONLY_RULE_CATALOG.md produced as canonical synthesis) + pair Phase 1+2 audit (S66, PAIR_DECISION_MATRIX.md produced). Earlier: Session 61 — **NULL RESULT: K-high cell catalog audit ships no rule; K-high cells formally labeled ML-only — the lesson from S60 generalizes from 6% to 34% drop-max rate**. Reused S60's `test_rule_catalog.py` harness verbatim; sanity check reproduced Rule 15's documented +$51/1000h whole-grid shipped lift to 0.7% — **harness now validated on TWO independent shipped rules (Rule 14 +$131 to 0.2%, Rule 15 +$51 to 0.7%)**. Phase 2 cell-by-cell audit of Rule 15: remaining K-high gap to oracle = $176.35/1000h whole-grid (DS_NO_JOINT $105.94 = 60%; DS_NO_MAXTOP $36.76; MS_ONLY $18.26; JOINT_HIGH $12.45; rest small). vs v44_dt's $110.94/1000h K-high residual, v44 captures ~$65 more than Rule 15. **Within-cell DSnj gap is 31% deeper at K than A** ($3,062/1000h vs $2,337/1000h) — the structural consequence of oracle dropping K off top 34% in this cell while Rule 15 keeps K on top 100%. Phase 3+4 tested **7 K-specific candidate refinement rules** across DSnj and MSonly; **every candidate failed Threshold 1**. Most striking: C_K1 (drop K to top ≤ 7 + DS bot + ms_mid_high ≥ J) fired at **34.9% — almost EXACTLY oracle's drop-K rate of 34%** — and was net **−$20.08/1000h WG**. The set MEMBERSHIP is what matters, not the COUNT. C_K6 (HIBOT tiebreaker control) shipped −$21.73/1000h — empirical post-hoc validation that S51's HIMID design choice was correct (mirror of the C10 result that validated Rule 14 in S60). Two micro-positive candidates (C_K3 Q-on-top tight gate +$3.53; C_K7 top=2 surgical +$1.05) exist but combined ($+4.58/1000h WG) still under T2's $5/1000h bar. **Three methodology lessons**: (i) drop-max rate is NOT a recoverable quantity for simple gates, EVEN AT 34% (lesson generalizes from 6% to 34%); (ii) the catalog approach systematically validates HIMID design choices across max-ranks; (iii) K-high cells are STRUCTURALLY DEEPER than A-high but exhibit the same rule-saturation. **No production change**: v52_full_high_only_handler ($2,498 full / $1,522 prefix) and v44_dt ($1,081 full / $686 prefix) BOTH UNCHANGED. The two tracks still diverge by $1,417/1000h. **Two-thirds of high_only's WG residual ($457 of $755) now formally in ML-only zone after two audits.** Harness PROVEN AND READY for S62 (Q-high), where oracle drops max off top 52% in Q × DSnj — the most aggressive drop-max profile of zones tested so far. `SESSION_61_K_HIGH_CATALOG.md` produced as the second page of the eventual `HIGH_ONLY_RULE_CATALOG.md`. Earlier: Session 60 — **NULL RESULT: A-high cell catalog audit ships no rule; A-high cells formally labeled ML-only**. Built `test_rule_catalog.py` per-cell rule audit harness; sanity check reproduced Rule 14's documented +$131.25/1000h whole-grid lift (matches S50 to 0.2%) — **harness validated**. Phase 2 cell-by-cell audit of Rule 14: remaining A-high gap to oracle = $281.2/1000h whole-grid (DS_NO_JOINT $161.7 = 58%; DS_NO_MAXTOP $55.1; MS_ONLY $35.4; JOINT_HIGH $26.7; rest small). vs v44_dt's $182.5/1000h A-high residual, v44 captures ~$99 more than Rule 14. Phase 3+4 tested **10 candidate refinement rules** across the 3 leakiest cells; **every candidate failed Threshold 1**. Most striking: C1 (switch DS_mu → SS+ms_mid whenever achievable) was net **−$96.9/1000h whole-grid** — oracle picks tA_SS_ms 27.9% of DSnj but a deterministic gate firing on 93% of cell catastrophically harms the 72% where DS was correct. C10 (HIBOT tiebreaker replacing Rule 14's HIMID) shipped **−$40/1000h** — empirical post-hoc validation that S50's HIMID design choice was correct. **Two methodology lessons**: (i) decision-matrix percentages overstate refinement headroom — "oracle picks X 28%" means "oracle knows WHICH 28%", not "switching to X recovers EV"; (ii) Rule 14 audit confirms HIMID is optimal among tested tiebreakers. **No production change**: v52_full_high_only_handler ($2,498 full / $1,522 prefix) and v44_dt ($1,081 full / $686 prefix) BOTH UNCHANGED. The two tracks still diverge by $1,417/1000h. Harness PROVEN AND READY for S61 (K-high), where structural conditions are different (oracle drops K off top 34% in K × DSnj vs 6% at A) and the C9-style drop-max play may clear thresholds. `SESSION_60_A_HIGH_CATALOG.md` produced as the first page of the eventual `HIGH_ONLY_RULE_CATALOG.md`. Earlier: Session 59 — **NULL RESULT: v45_dt does NOT ship**. 4 rank-valued `ho_v5_*_g` features designed from HO13's stratification of v44's non-max-joint quality residuals (max_mid_high in non-max joints + best_combined_q + max_in_bot_pair_n + 4f topMax_n_configs) added only **+9 leaves** to v44's 2.248M-leaf tree and shipped **$0/1000h lift on both full and prefix grids**. v44_dt remains the ML champion at $1,081 full / $686 prefix. Feature importance #66/#97/#106/#110 (sum 0.09%) — the LOWEST per-ship in project history. **Methodology lesson: the 4-phase playbook hits a saturation ceiling at depth=36 ml=1 + ~2.25M leaves on 6M rows after 3 consecutive same-zone passes.** HO11/HO12/HO13 verified the data signal IS real (K × DS_NO_JOINT × best_top=Q × mid_h≥J is a $9.76/1000h cell with a 30.5% pick-rate gap), but ho_v5 features are mathematically derivable from ho_v4 + base, so the DT cannot exploit them at saturation. Session 60 should pivot to (a) surgical RULE on the HO13-identified cell, (b) trips zone for a fresh playbook application, or (c) different model class. The two production tracks STILL diverge by $1,417/1000h (rule chain v52 at $2,498 / $1,522 — UNCHANGED; ML champion v44_dt at $1,081 / $686 — UNCHANGED). Earlier: Session 58 — **v44_dt new ML champion via the S54 playbook applied to high_only zone — THIRD PASS (+$42 full / $0 prefix vs v43_dt)**: 4 rank-valued `ho_v4_*_g` features encoding three structural axes invisible to v43: DS bot pair_high quality with top=max (DS_NO_JOINT cell discrimination), 4-flush+ms_mid with top=max (Ace-high alt route), and non-max-top joint achievability + best non-max top rank (the "max-into-bot" route at lower ranks). Five drills (HO5–HO10) on all 1.226M high_only hands surfaced the deepest residuals: (1) `DS_NO_JOINT` cell is dominant at 62.9% × every max-rank, contributing ~69% of high_only regret; v43 under-routes DS bot by 10–20% there. (2) Within JOINT picks, oracle is mid-first (mean mid_pct 0.67–0.81 >> bot_pct 0.24–0.36) — v43 already covers this via ho_v3_max_mid_high. (3) JOINT take-rate collapses with lower max-rank (A:95% → 8:13%); 47.7% of high_only hands have a non-max-top joint achievable that v43 cannot see. (4) At max=A, 4f+ms is the dominant alt (54% of A-alt picks). v43 → v44: $1,123 → $1,081 full / $686 → $686 prefix; **high_only within-cat $2,075 → $1,868 (−$207, −10.0%); high_only pct_opt 37.9% → 41.8% (+3.9%)**. v44 is the new ML champion at 2.25M leaves / 107 features (depth=36 ml=1, +3.2% leaves over v43). Feature importance #47/#80/#93/#95 (0.13%/0.04%/0.01%/0.01%) — yet ships +$42 via surgical gating. Cumulative v32 → v44 = −$634 full / −$218 prefix (9 ML ships). All 7 non-targeted categories byte-identical to v43 on both grids (surgical via gating). p90 0.400 → 0.390; p99 0.980 → 0.970. **Three-session high_only collapse (S55→S58): $2,796 → $2,411 → $2,075 → $1,868 = −$928 within-cat (−33.2%)** — composing three conditional axes (ho_v2 DS-only + ho_v3 DS+ms-joint + ho_v4 DS-quality+non-max-joint+4f) compresses the same zone three times without surgical interference. **Methodology validation: the 4-phase playbook is transferable to the SAME zone for a THIRD pass; decision matrix is a separable deliverable from the ML ship.** Also produced `SESSION_58_HIGH_ONLY_DECISION_MATRIX.md` at repo root — per-max-rank × per-cell oracle TOP/BOT/MID profile + trade-off rules — answering the user's S57 review question. End-of-S58 residual map: high_only $1,868/1000h within-cat (STILL dominant — $762/1000h whole-grid = ~71% of v44's regret), pair $1,097, two_pair $363, trips $1,194, trips_pair $281, three_pair $1,613, quads $545, composite $960. Rule chain unchanged at v52 ($2,498 full / $1,522 prefix). **The two production tracks now diverge by $1,417/1000h** — ML champion beats rule chain by more than half its EV deficit.) (Earlier: Session 57 — **v43_dt new ML champion via the S54 playbook applied to high_only zone — SECOND PASS (+$69 full / $0 prefix vs v42_dt)**: 4 rank-valued `ho_v3_topMax_DS_ms_*_g` features encoding JOINT (DS bot + ms mid) achievability + quality conditional on top=max-rank-of-hand. After S56's ho_v2 features collapsed the DS-only axis, the SAME SS→DS pattern remained dominant — but with a NEW axis (mid-suiting). Phase 1 confirmed v42 STILL over-routes SS bot (46.07% vs oracle 32.04%, −14.0%). Phase 1b confirmed 100% of dominant-class mismatches have a (DS bot + ms mid) JOINT config achievable WITH the Ace on top. v42 → v43: $1,192 → $1,123 full / $686 → $686 prefix; **high_only within-cat $2,411 → $2,075 (−$336, −13.9%); high_only pct_opt 33.4% → 37.9% (+4.5%)**. v43 is the new ML champion at 2.18M leaves / 103 features (depth=36 ml=1, +3.2% leaves over v42). Feature importance is the LOWEST per-ship in the project (#63/#64/#100/#102 at 0.07%/0.07%/0.01%/0.00%) — yet ships +$69 via surgical gating. Cumulative v32 → v43 = −$592 full / −$218 prefix (8 ML ships). All 7 non-targeted categories byte-identical to v42 on both grids (surgical via gating). p90 0.425 → 0.400; p99 1.035 → 0.980. **Two-session high_only collapse (S55→S57): $2,796 → $2,411 → $2,075 = −$721 within-cat (−25.8%)** — composing two conditional axes (ho_v2 DS-only + ho_v3 DS+ms-joint) compresses the same zone twice without surgical interference. **Methodology validation: the 4-phase playbook is transferable to the SAME zone for a SECOND pass**; joint achievability is a distinct structural axis from single-axis achievability; user predictions can be wrong about WHICH axis dominates even after one pass collapses one axis. End-of-S57 residual map: high_only $2,075/1000h within-cat (STILL dominant — $838/1000h whole-grid = ~75% of v43's regret), pair $1,097, two_pair $363, trips $1,194, trips_pair $281, three_pair $1,613, quads $545, composite $960. Rule chain unchanged at v52 ($2,498 full / $1,522 prefix). **The two production tracks now diverge by $1,375/1000h** — ML champion beats rule chain by more than half its EV deficit.) (Earlier: Session 56 — **v42_dt new ML champion via the S54 playbook applied to high_only zone (+$79 full / $0 prefix vs v41_dt)**: 4 rank-valued `ho_v2_bot_DS_*_g` features mirroring pair_aug_v5 / trips_pair_v2 / two_pair_v2 patterns target the dominant high_only blind spot — DS-bot achievability with Ace-top preserved. v41 → v42: $1,270 → $1,192 full / $686 → $686 prefix; **high_only within-cat $2,796 → $2,411 (−$385, −13.8%); high_only pct_opt 29.0% → 33.4% (+4.4%)**. v42 is the new ML champion at 2.11M leaves / 99 features (depth=36 ml=1, +4.7% leaves over v41). 3 of 4 new features in top-32 importance (#26, #31, #32). Cumulative v32 → v42 = −$524 full / −$218 prefix (7 ML ships). All 7 non-targeted categories byte-identical to v41 on both grids (surgical via gating). p90 0.450 → 0.425; p99 1.075 → 1.035. **Phase 1b 100% confirmation** (100% of dominant-class mismatches have max_top=A available in DS configs AND 100% of oracle picks use it) — the cleanest Phase 1b validation in the project. **User-prediction "different feature types needed" was partially correct, partially wrong**: the dominant high_only blind spot was the SAME DS-routing pattern as prior zones; only the bot suit profile differs in 100% of mismatches, not the top-card choice. **Methodology validation: the 4-phase playbook is fully transferable to the largest population zone (40.4%) without modification.** Methodology lessons: surgical-gating means prefix-grid neutrality is correct (not suspect) when the prefix slice doesn't contain the targeted population; when a feature family (DS-bot achievability) is missing entirely from a zone, that gap dominates even when other axes also exist; single-axis ships have predictable leaf growth (+4.7% here vs +32% for v41's two_pair v2). End-of-S56 residual map: high_only $2,411/1000h within-cat (STILL the dominant residual — $975/1000h whole-grid = ~82% of v42's total regret), pair $1,097, two_pair $363, trips $1,194, trips_pair $281, three_pair $1,613, quads $545, composite $960. Rule chain unchanged at v52 ($2,498 full / $1,522 prefix). **The two production tracks now diverge by $1,306/1000h** — ML champion beats rule chain by more than half its EV deficit.) (Earlier: Session 55 — **TWO ML ships in one session: v40_dt + v41_dt — second-largest combined session lift after S54 (+$142 full / +$115 prefix vs v39_dt)**: applied the Session 54 diagnostic-driven feature engineering playbook to TWO residual zones. Track A: trips_pair ship as v40_dt with 4 rank-valued `tp_v2_*_g` features mirroring pair_aug_v5 pattern for Pbot_DS routings (R1+R2+R3); v39 → v40: $1,412 → $1,394 full / $801 → $772 prefix; **trips_pair within-cat $909 → $281 (−69%); pct_opt 64.2% → 85.1% (+20.9%)**. Track B: two_pair ship as v41_dt with 4 rank-valued `t2p_v2_*_g` features completing the Layout B/C asymmetry (existing `t2p_n_layout_b_routings_ds_g` had no Layout C equivalent — asymmetric blind spot); v40 → v41: $1,394 → $1,270 full / $772 → $686 prefix; **two_pair within-cat $918 → $363 (−60%); pct_opt 66.6% → 83.2% (+16.6%)**. v41 is the new ML champion at 2.02M leaves / 95 features. Cumulative v32 → v41 = −$445 full / −$218 prefix (6 ML ships). All non-targeted categories byte-identical in both ships (surgical via gating). p90 0.480 → 0.450; p99 1.090 → 1.075. **Methodology validation: the S54 playbook is now TRANSFERABLE across ML residual zones** — identical Phase 1/1b/2 shape, identical feature suite shape, identical depth=36 ml=1 hyperparams. Methodology lesson: asymmetric existing features signal blind spots; low individual feature importance (0.02-0.04%) can still ship lift via surgical gating; population size dominates leaf-growth potential (v40: +3.4% leaves over 2.86% zone; v41: +32% leaves over 22.3% zone). End-of-S55 residual map: high_only $2,796/1000h within-cat (BY FAR the largest remaining residual; ~63% of v41's total regret), pair $1,097, two_pair $363 (S55-compressed), trips $1,194, trips_pair $281 (S55-compressed), three_pair $1,613, quads $545, composite $960. Rule chain unchanged at v52 ($2,498 full / $1,522 prefix). **The two production tracks now diverge by $1,228/1000h** — ML champion beats rule chain by nearly half its EV deficit.) (Earlier: Session 54 — **v39_dt ships as new ML champion — LARGEST single ML retrain ship in project history (+$237 full / +$90 prefix vs v36_dt)**: 4 rank-valued conditional features `pair_aug_v5_*_g` targeting the pair-zone gap diagnosed via per-(max, pair) cell mismatch matrix. v36 → v39: $1,649 → $1,412 full ($891 → $801 prefix); pct_opt 53.61% → 57.88% full / 62.61% → 64.55% prefix. **Pair zone within-category $1,604 → $1,097 (−$507, −32%); pair pct_opt 56.6% → 65.7% (+9.1%).** All other categories byte-identical to v36 (gating worked surgically). Leaf count +43% (1.06M → 1.52M); depth saturation broke from 33 to 36. 3 of 4 new features in top-30 importance. Cumulative v32 → v39 = −$303 full. Methodology breakthrough: rank-valued conditional features describing the QUALITY of the alternative configuration unlock saturated trees — Phase 2 v1's booleans (v38) shipped $0 because they were redundant with existing suit features. The pair zone was the dominant ML residual for sessions and was cracked cleanly with diagnostic-driven feature design. Rule chain v52 unchanged at $2,498 full / $1,522 prefix. Earlier: Session 53 overnight — **Rule 17 ships in production as v52 = comprehensive high_only generalized handler**: addresses ALL high_only no-pair sub-pops (max ≥ 7) with the right offensive vs defensive structure per-cell. Trigger + setting cascade: (1) Defensive lowest-on-top + DS-bot HIMID for max ∈ {T, 9, 8, 7} ALWAYS, and for max ∈ {J, Q, K} when 2nd-high ≤ 8; (2) HIMID for max=J when not defensive; (3) v47's Rules 14-16 for max ∈ {Q, K, A}. v47 → v52 score: $2,515 → $2,498 full, $1,522 → $1,522 prefix (UNCHANGED — high_only zero prefix coverage). pct_opt: 43.30% → 43.34% full. high_only $3,096 → $3,014 (−$82, −2.6%). p90 regret IMPROVED 0.725→0.720. Cumulative v39 → v52 = −$348 full / −$185 prefix; v14 → v52 = −$535 full. Origin: per-(max, s2) characterization revealed that for max ≤ T oracle picks max-on-top only 3-15% (vs HIMID forces it 100%). v52 corrects with always-defensive for low-max + gated K/Q/J + skip A-high (where A-on-top is universally optimal). Sister strategies v48 (HIMID-only +$8) and v50 (HIMID + A/K/Q/J defensive, regressed −$6 vs v48) confirmed the design choice. The S43-S53 arc has shipped 9 production rules totaling −$348 full / −$185 prefix.) (Earlier: Session 52 — **Rule 16 ships in production as v47**: trigger = cat=high_only AND max=Q AND DS-bot OR SS-bot achievable with Q on top. Setting builder: TOP=Q always, try DS-bot first then SS-bot fallback, HIMID tie-break (parallel to Rules 14/15). v46 → v47 score: $2,534 → $2,515 full, $1,522 → $1,522 prefix (UNCHANGED — high_only zero prefix coverage). pct_opt: 43.24% → 43.30% full. high_only $3,187 → $3,096 (−$91, −2.9%). Cumulative v39 → v47 = −$330 full / −$185 prefix; cumulative v14 → v47 = −$518 full. Origin: Drill N characterization (n=150,150 = 2.5% of grid) found Q-high contributes $112/1000h whole-grid regret. Critical finding: Q-on-top is borderline — oracle picks Q on top only 49.37% (vs A 93%, K 66%); 51% non-Q-on-top sub-zone includes 16% defensive 2-on-top. The three-session high_only sub-arc (S50-S52, Rules 14/15/16) shows diminishing returns: A-high −$131 → K-high −$51 → Q-high −$19, totaling −$201 across the A+K+Q sub-pops (19% of grid). Per-fire DS lift INCREASES (worse baseline) but pop size DECREASES, leading to shrinking absolute ships. J-high estimated +$8-12 — below threshold for further single-pop drills. The S43-S52 arc has shipped 8 production rules totaling −$330 full / −$185 prefix.) (Earlier: Session 51 — **Rule 15 ships in production as v46 — 3rd-LARGEST SINGLE-RULE LIFT IN PROJECT HISTORY (+$51/1000h whole-grid full)**: trigger = cat=high_only AND max=K AND DS-bot OR SS-bot achievable with K on top. Setting builder: TOP=K always, try DS-bot first then SS-bot fallback, in both cases use HIMID tie-break (parallel to Rule 14). v45 → v46 score: $2,585 → $2,534 full, $1,522 → $1,522 prefix (UNCHANGED — high_only zero prefix coverage). pct_opt: 43.05% → 43.24% full / 53.06% (unchanged) prefix. high_only $3,439 → $3,187 (−$252 within high_only, −7.3%). high_only pct_opt 23.3% → 24.2% (+0.9%). p90 regret IMPROVED 0.745→0.730. Cumulative v39 → v46 = −$311 full / −$185 prefix. Origin: Drill M characterization (n=330,330 K-high no-pair = 5.5% of grid) found K-high contributes $226/1000h whole-grid regret (2nd-largest residual after A-high's $412). Critical difference vs A-high: oracle picks K on top only 66% of the time (vs A on top 93%) — the 34% non-K-on-top sub-zone is a known Rule 15 v2 candidate. Best-in-DS vs v45 = +$2,999/1000h within fires (LARGER per-fire lift than A-high's +$1,937 due to weaker baseline). The S43-S51 arc has now shipped 7 production rules totaling −$311 full / −$185 prefix — average ship −$44/1000h per rule.) (Earlier: Session 50 — **Rule 14 ships in production as v45 — LARGEST SINGLE-RULE LIFT IN PROJECT HISTORY (+$131/1000h whole-grid full)**: trigger = cat=high_only AND max=A AND DS-bot OR SS-bot achievable with A on top. Setting builder: TOP=A always, try DS-bot first then SS-bot fallback, in both cases use HIMID tie-break (mid keeps the 2 highest non-A cards). v44 → v45 score: $2,717 → $2,585 full, $1,522 → $1,522 prefix (UNCHANGED — high_only has zero prefix coverage). pct_opt: 42.34% → 43.05% full / 53.06% → 53.06% prefix. high_only category $4,082 → $3,439 (−$643 within high_only, 16% reduction). high_only pct_opt 19.8% → 23.3% (+3.5%). p90 regret IMPROVED 0.785→0.745. Beats v33's Rule 6 (+$113, S37) which had held the single-rule record for 13 sessions. Cumulative v39 → v45 = −$260 full / −$185 prefix. Origin: Drill K characterization (n=660,660 = 11% of grid) found A-high no-pair has $412/1000h whole-grid regret contribution (single largest residual zone); v44 over-DS's (59% vs oracle 48%), picks rainbow 13× too often (11% vs 0.83%), and under-uses 3+1 (4% vs 14%). Drill L heuristic sweep found HIMID is the right tie-break, NOT HIBOT — counter to "stack high cards in bot for kicker strength" intuition. Mechanism: with A on top, K+Q etc. belong in MID for Hold'em scoring; lower 4 cards form bot's Omaha play where suit matters more than rank. The S43-S50 arc has now shipped 6 production rules totaling −$260 full / −$185 prefix — the project's largest multi-rule family.) (Earlier: Session 48 — **Rule 13 ships in production as v44**: trigger = cat=three_pair AND (MM_mid_DS achievable OR HH_mid_DS achievable). Setting builder: try MM_mid first (mid=MM pair, bot=HH+LL pairs, top=singleton — V_MM_MID +$2,463/1000h within fires), else HH_mid (V_HH_MID +$2,227); SKIP LL_mid-only cases (V_LL_MID is catastrophic at -$4,117/1000h within fires). **Lift: +$11/1000h whole-grid full + +$29/1000h whole-grid prefix.** v43 → v44 score: $2,727 → $2,717 full, $1,550 → $1,522 prefix. pct_opt: 42.20% → 42.34% full / 52.61% → 53.06% prefix. **three_pair regret $2,268 → $1,696 (−$572 within category, 25% reduction). three_pair pct_opt 51.5% → 59.3% (+7.8% — the largest single-category pct_opt jump from any rule ship in the project).** Surprising drill finding: three_pair within-class DS does NOT favor "highest pairs in bot" (V_LL_MID catastrophic at -$4,117/1000h within fires) — opposite of two_pair where HH-to-bot wins; mechanism is that LL in mid is too weak a Hold'em hand and the HH+MM bot upgrade can't compensate. Skip-the-trap design pattern: explicitly exclude LL_mid-only cases. Cumulative v39 → v44 = −$129 full / −$185 prefix; the suit-dominance arc has shipped 5 production rules (v40b → v41 → v42 → v43 → v44) across 6 sessions, the project's largest multi-rule family from a single methodology breakthrough (S44 within-hand pairwise). Also Session 48: Rule 12 max≤Q extension (v43b) tested and DEFERRED — full +$14 but prefix regresses −$6 with pct_opt drop 52.61%→52.45%; passes strict 2x gate but qualitative prefix regression undermines confidence.) (Earlier: Session 47 — **Rule 12 ships in production as v43**: trigger = cat=two_pair AND max≤J AND DS-bot achievable with both pairs intact. Setting builder: try HH-to-bot first (HH 2 + 2 singletons completing 2+2 DS pattern), else try LL-to-bot, else fall through to v42; MID = the OTHER pair (anchor preserved); TOP = leftover singleton (deterministic). **Lift: +$35/1000h whole-grid full + +$66/1000h whole-grid prefix** — both grids strongly positive. v42 → v43 score: $2,763 → $2,727 full, $1,616 → $1,550 prefix. pct_opt: 41.93% → 42.20% full / 51.81% → 52.61% prefix. Two_pair regret −$160 within two_pair. **Largest single-rule full-grid lift since v33's Rule 6 (Session 37, +$113).** Origin: Drill B's B1−B2 = +$1,864/1000h sister candidate validated. Drill F sweep showed HH-to-bot wins (+$1,808 within fires) over LL-to-bot (+$1,044). Hybrid covers all 120,960 fires (46.2% of J-low two_pair). Cumulative v39 → v43 = −$118 full / −$157 prefix. The S45-S47 suit-dominance arc (Rule 10 v3 → Rule 11 → Rule 12) ships three rules from the S44 within-hand pairwise insight, totaling −$118 full. Also Session 47 Drill E (Rule 11 heuristic variant sweep) was a negative result — v42's V_LOLO is empirically optimal among 6 simple tie-break variants; the +$1,794/1000h within-fires gap to A5 oracle requires more sophisticated logic.) (Earlier: Session 46 — **Rule 11 ships in production as v42**: first single-cell rule of the project. Trigger: cat=pair AND P=11 AND max_rank=11 (the J-pair-J cell, 34,272 hands = 0.57% of grid) AND DS-bot achievable with both J's in bot. Setting: both J's go to BOT; pick 2 singletons (lowest-rank pair available such that the bot's 4-card suit pattern is 2+2 = DS); TOP = lowest of remaining 3 singletons; MID = the other 2. **Lift: +$6/1000h whole-grid full + $0 prefix (unchanged — Rule 11 fires on 0 prefix hands; J-pair-J has zero prefix coverage).** v41 → v42 score: $2,769 → $2,763 full. pct_opt: 41.91% → 41.93% full. Origin: Drill A's per-pair-rank A5−A2 breakdown (Session 45) found a sharp positive flip at P=J (+$2,975 vs negative at P=2..T). Drill D (Session 46, focused J-pair-J) confirmed via the apples-to-apples comparison A5−A1 = +$1,004/1000h, and v41 vs A5-best = +$3,769/1000h (the largest cross-class override at J-pair-J). v41 picks A5 0% of fired hands. Rule 11 captures ~56% of A5's oracle ceiling — heuristic-sharpening queued. Cumulative v39 → v42: −$83 full / −$91 prefix. Rule 11 is the first **single-cell** rule of the project (vs prior Rules 1-10 which all had broader populations).) (Earlier: Session 45 — **Rule 10 v3 ships in production as v41**: same trigger + gate as v40b (cat=pair, max≤J, P≤6 OR P==max), but with **suit-aware bot construction** — pick the TOP-candidate singleton such that the remaining 4 form a DS bot when achievable; fall back to v40b's "TOP = lowest singleton" otherwise. **Lift: +$29/1000h whole-grid (full N=200) + +$54/1000h whole-grid (prefix N=1000)**, both grids strongly positive with no per-category regression. v40b → v41 score: $2,798 → $2,769 full, $1,670 → $1,616 prefix. pct_opt: 41.48% → 41.91% full / 50.64% → 51.81% prefix. Mechanism: keeping pair-in-mid AND picking singletons that yield a DS bot is +$2,756/1000h within-hand on the 47.8% of J-low pair hands where DS is achievable without breaking the pair (Drill A's A1−A2). Drill A also confirmed **pair structure dominates suit structure universally** — breaking the pair to enable DS-bot is catastrophic (A3−A2 = −$10,304/1000h). Drill B (J-low two_pair) confirmed the same answer with even larger margins (B3−B2 = −$9,030, B7−B2 = −$23,165); within-class B1−B2 = +$1,864 is a sister Rule 11+ candidate. Drill C (S44 carryover) showed DS one-gap-4 ≥ DS run-4 does NOT robustly generalize across categories — sign flips by category. Earlier Session 43 ship (v40b, +$48 full / +$37 prefix) and Session 42 overnight ship (v39, Rule 9 a/b/c) cumulate to v39 → v41 = −$77 full / −$91 prefix.) (Earlier: Session 43 — **Rule 10 (J-low single-pair defensive, GATED variant) ships in production** as v40b — the FIRST defensive rule of the project. Trigger: pair hands with max card ≤ J AND (pair_rank ≤ 6 OR pair_rank == max_rank). Setting: TOP = lowest singleton, MID = the pair, BOT = 4 highest non-pair singletons. **Lift: +$48/1000h whole-grid (full N=200) + +$37/1000h whole-grid (prefix N=1000)** — both grids strongly positive. **Largest single-rule full-grid lift since v33's Rule 6 (Session 37, +$113/1000h)**. The simple ungated variant (v40) ships +$23 full / +$37 prefix and is retained as sister artifact for human-memorization fork. The gate adds one condition that doubles the lift by excluding the per-cell regression zone (pair_rank ∈ (max-4, max-1), e.g., 99 on J-high). Mechanism: the **weak-hand top inversion** — when the highest card cannot reliably win the top tier (top wins only 1 point/board vs mid's 2 and bot's 3), dumping the LOWEST card on top costs less than the gain in bot+mid equity from upgrading kicker strength. Discovered in `drill_low_pair_J_high_defense.py`. Other Session 43 findings: Q1 (A-high "always Ace on top") confirmed — v3 already at 96% optimality, no rule needed; Q2 (K/Q-high "break broadway for 4-flush bot") FAILED — every variant regressed $10-27/1000h; Q4 (J-low two_pair defensive re-examination) confirmed Session 42's "two_pair is ML territory" verdict (all 6 deterministic candidates regress); Q5 (J-high no-pair top=lo) deferred — works on T-low (+$8 full only) but regresses on J-high; high_only has zero prefix coverage so both-grid gate inapplicable.)
