"""
Session 58 — strategy_v44_dt: v43 + 4 high_only_aug_v4 rank-valued
features (107 total). Encodes DS bot pair_high quality with top=max,
4-flush + ms route with top=max, non-max-top joint achievability count,
and best non-max top rank in those joints.
"""
...
MODEL_PATH = ROOT / "data" / "v44_dt_model.npz"
...
def strategy_v44_dt(hand: np.ndarray) -> int:
    model = load_model()
