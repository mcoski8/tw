"""
Session 30 — strategy_v19_gated_dt: extends v18c with 6 GATED
suited-broadway features (zeros for non-high_only hands).
"""
...
MODEL_PATH = ROOT / "data" / "v19_gated_dt_model.npz"
...
def strategy_v19_gated_dt(hand: np.ndarray) -> int:
    model = load_model()
