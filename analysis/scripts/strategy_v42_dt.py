"""
Session 56 — strategy_v42_dt: v41 + 4 high_only_aug_v2 rank-valued features (99 total).
"""
...
MODEL_PATH = ROOT / "data" / "v42_dt_model.npz"
...
def load_model(path: Optional[Path] = None) -> dict:
    ...
    all_gated = [
        ...
        set(_T2P_V2_NAMES), set(_HO_V2_NAMES),
    ]
...
def strategy_v42_dt(hand: np.ndarray) -> int:
    model = load_model()
