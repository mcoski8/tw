#!/usr/bin/env python3
"""Grade v56 (v52 + Rule 19 trips_pair force V_B) vs v52."""
...
def main() -> int:
    ...
    from strategy_v56_rule19_trips_pair_VB import strategy_v56_rule19_trips_pair_VB
    ...
    res_v56 = grade_strategy(strategy_v56_rule19_trips_pair_VB, grid, ch,
                              label="v56 (v52 + Rule 19 trips_pair V_B)",
                              progress_every=progress_every)
    print(res_v56.summary(), flush=True)

    print("\n" + "=" * 70)
    print(f"v56 vs v52 ({args.grid} grid)")
    print("=" * 70)
    print(compare_grades(res_v52, res_v56))
    delta = res_v52.mean_regret - res_v56.mean_regret
    print(f"\nv56 vs v52: {delta:+.4f}  ≈ ${delta * 10 * 1000:+,.0f}/1000h",
          flush=True)
    return 0
