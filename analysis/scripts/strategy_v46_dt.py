"""
Session 72 — strategy_v46_dt: v44 + 2 high_only_aug_v6 rank-valued
features (109 total).

ho_v6 adds the SS+ms route quality enumeration with top=max-rank (direct
SS-axis counterpart to ho_v3's DS-axis pair). See train_v46_dt.py for
context.
"""
...
MODEL_PATH = ROOT / "data" / "v46_dt_model.npz"
...
def strategy_v46_dt(hand: np.ndarray) -> int:
    model = load_model()
