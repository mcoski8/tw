#!/usr/bin/env python3
"""Grade v55 (v52 + Rule 18 v2 HIBOT) vs v52."""
...
def main() -> int:
    ...
    from strategy_v55_rule18_hibot import strategy_v55_rule18_hibot
    ...
    res_v55 = grade_strategy(strategy_v55_rule18_hibot, grid, ch,
                              label="v55 (v52 + Rule 18 v2 HIBOT)",
                              progress_every=progress_every)
    print(res_v55.summary(), flush=True)

    print("\n" + "=" * 70)
    print(f"v55 vs v52 ({args.grid} grid)")
    print("=" * 70)
    print(compare_grades(res_v52, res_v55))
    delta = res_v52.mean_regret - res_v55.mean_regret
    print(f"\nv55 vs v52: {delta:+.4f}  ≈ ${delta * 10 * 1000:+,.0f}/1000h",
          flush=True)
    return 0
