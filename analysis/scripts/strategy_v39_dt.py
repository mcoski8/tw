"""
Session 54 — strategy_v39_dt: v36 + 4 pair_aug_v5 rank-valued features (87 total).
"""
...
MODEL_PATH = ROOT / "data" / "v39_dt_model.npz"
...
def load_model(path: Optional[Path] = None) -> dict:
    ...
    all_gated = [
        ...
        set(_TRIPS_V2_NAMES), set(_PAIR_V5_NAMES),
    ]
...
def strategy_v39_dt(hand: np.ndarray) -> int:
    model = load_model()
