"""
Session 63 — Test S63 J-high candidate rules against v52 baseline.

Mirrors test_Q_high_candidates_S62.py exactly. Runs each candidate from
candidates_J_high_S63 through the test_rule_catalog harness on its
...
from candidates_J_high_S63 import CANDIDATES  # noqa: E402
from strategy_v52_full_high_only_handler import strategy_v52_full_high_only_handler  # noqa: E402

OUT_JSON = ROOT / "data" / "session_63_candidate_results.json"
JACK = 11
...
def main() -> int:
    print("=" * 88)
    print("Session 63 — J-high candidate sweep vs v52 baseline")
    print("=" * 88)
    ...
    for name, (fn, cell) in CANDIDATES.items():
        ...
        try:
            r = test_rule_on_cell(
                rule_fn=fn, max_rank=JACK, cell=cell,
