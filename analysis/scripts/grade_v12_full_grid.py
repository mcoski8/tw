#!/usr/bin/env python3
"""Grade v12 (trips_pair routing) alongside v10 + v11-archived on full grid."""
...
def main() -> int:
    ...
    v10 = results[1]
    v12 = results[2]
    print(f"\nv12 vs v10 (incremental): {v10.mean_regret - v12.mean_regret:+.4f}  ≈ ${(v10.mean_regret - v12.mean_regret) * 10 * 1000:+,.0f}/1000h")
    print(f"v12 vs v8  (cumulative):  {v8.mean_regret - v12.mean_regret:+.4f}  ≈ ${(v8.mean_regret - v12.mean_regret) * 10 * 1000:+,.0f}/1000h")
    return 0
