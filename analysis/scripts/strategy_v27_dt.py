"""
Session 34 — strategy_v27_dt: extends v26 with 4 high_only-gated aug
features. At runtime computes all 6 gated families plus base vector,
walks the saved tree.
"""
...
def strategy_v27_dt(hand: np.ndarray) -> int:
    model = load_model()
