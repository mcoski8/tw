"""
Session 35 — strategy_v29_dt: extends v27 with 4 pair-gated v2 aug
features (the `pair_r4_*_g` family). At runtime computes all 7 gated
...
def strategy_v29_dt(hand: np.ndarray) -> int:
    model = load_model()
