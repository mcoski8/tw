"""
Session 57 — persist 4 high_only_aug_v3 features to parquet.

Output: data/feature_table_high_only_aug_v3_gated.parquet
"""
...
from high_only_aug_v3_features_gated import compute_high_only_v3_features_batch  # noqa: E402

OUT = ROOT / "data" / "feature_table_high_only_aug_v3_gated.parquet"
...
print("computing high_only_aug_v3 features ...")
t0 = time.time()
augmented = compute_high_only_v3_features_batch(hands)
print(f"  done ({time.time()-t0:.1f}s)")

table = pa.table({
    "canonical_id": np.arange(N, dtype=np.uint32),
    "ho_v3_topMax_DS_ms_n_configs_g":
        pa.array(augmented["ho_v3_topMax_DS_ms_n_configs_g"], type=pa.int8()),
    "ho_v3_topMax_DS_ms_max_mid_high_g":
        pa.array(augmented["ho_v3_topMax_DS_ms_max_mid_high_g"], type=pa.int8()),
    "ho_v3_topMax_DS_ms_min_mid_high_g":
        pa.array(augmented["ho_v3_topMax_DS_ms_min_mid_high_g"], type=pa.int8()),
    "ho_v3_topMax_DS_ms_max_mid_sum_g":
        pa.array(augmented["ho_v3_topMax_DS_ms_max_mid_sum_g"], type=pa.int8()),
})
...
for c in ("ho_v3_topMax_DS_ms_n_configs_g",
          "ho_v3_topMax_DS_ms_max_mid_high_g",
          "ho_v3_topMax_DS_ms_min_mid_high_g",
          "ho_v3_topMax_DS_ms_max_mid_sum_g"):
    vals = back[c].values
