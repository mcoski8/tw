"""
Session 57 — strategy_v43_dt: v42 + 4 high_only_aug_v3 rank-valued
features (103 total). Encodes joint (DS bot + ms mid) achievability
quality conditional on top = max-rank-of-hand.
"""
...
MODEL_PATH = ROOT / "data" / "v43_dt_model.npz"
...
def load_model(path: Optional[Path] = None) -> dict:
    ...
    all_gated = [
        ...
        set(_T2P_V2_NAMES), set(_HO_V2_NAMES), set(_HO_V3_NAMES),
    ]
...
def strategy_v43_dt(hand: np.ndarray) -> int:
    model = load_model()
