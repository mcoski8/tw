#!/usr/bin/env python3
"""Grade v31b (v30 + 4 trips_v2 round-2 features) vs v30."""
...
def main() -> int:
    ...
    import strategy_v31b_dt as v31b_m
    ...
    v31b_m._MODEL_CACHE = None
    v31b_m.MODEL_PATH = REPO / "data" / "v31b_dt_model.npz"
    v31b_m.load_model()
    print("\nGrading v31b ...", flush=True)
    res_v31b = grade_strategy(v31b_m.strategy_v31b_dt, grid, ch,
                              label="v31b (v30 + trips_v2 round 2)",
                              progress_every=2_000_000 if args.grid == "full" else 200_000)
    print(res_v31b.summary(), flush=True)

    print("\n" + "=" * 70)
    print(f"SUMMARY ({args.grid} grid)")
    print("=" * 70)
    print(compare_grades(res_v30, res_v31b))
    delta = res_v30.mean_regret - res_v31b.mean_regret
    print(f"\nv31b vs v30: {delta:+.4f}  ≈ ${delta * 10 * 1000:+,.0f}/1000h", flush=True)
    return 0
