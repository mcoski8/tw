"""
Session 55 — strategy_v41_dt: v40 + 4 two_pair_aug_v2 rank-valued features (95 total).
"""
...
MODEL_PATH = ROOT / "data" / "v41_dt_model.npz"
...
def strategy_v41_dt(hand: np.ndarray) -> int:
    model = load_model()
