"""Session 36 — strategy_v31b_dt: extends v30 with 4 trips_v2 features."""
...
MODEL_PATH = ROOT / "data" / "v31b_dt_model.npz"

_SUITED_GATED_NAMES = ["n_suited_pairs_total_g","max_suited_pair_high_rank_g","max_suited_pair_low_rank_g","has_suited_broadway_pair_g","has_suited_premium_pair_g","n_broadway_in_largest_suit_g"]
_TRIPS_PAIR_GATED_NAMES = ["tp_trip_rank_g","tp_pair_rank_g","tp_high_singleton_rank_g","tp_low_singleton_rank_g","tp_singletons_suited_g","tp_pair_routing_is_ds_g"]
_COMPOSITE_GATED_NAMES = ["comp_archetype_g","comp_lower_trip_rank_g","comp_singleton_rank_g","comp_higher_pair_rank_g"]
_PAIR_GATED_NAMES = ["pair_kickers_in_pair_suit_max_g","pair_kickers_in_pair_suit_min_g","pair_default_top_rank_g","pair_alt_top_rank_g","pair_alt_mid_suited_g","pair_alt_mid_n_broadway_g"]
_TWO_PAIR_GATED_NAMES = ["t2p_layout_a_bot_is_ds_g","t2p_n_layout_b_routings_ds_g","t2p_top_singleton_rank_g","t2p_low_singleton_rank_g","t2p_singletons_max_suit_count_g","t2p_high_pair_rank_g"]
_HIGH_ONLY_GATED_NAMES = ["ho_n_broadway_in_2nd_suit_g","ho_n_broadway_in_3rd_suit_g","ho_connectivity_high_g","ho_n_broadway_pairs_adj_g"]
_PAIR_R4_GATED_NAMES = ["pair_r4_bot_suit_profile_g","pair_r4_bot_max_rank_g","pair_r4_n_broadway_kickers_g","pair_r4_n_low_kickers_g"]
_TRIPS_GATED_NAMES = ["trips_b_ds_avail_g","trips_b_ds_n_routings_g","trips_kickers_max_suit_count_g","trips_kickers_max_rank_g","trips_n_broadway_kickers_g","trips_n_low_kickers_g"]
_TRIPS_V2_GATED_NAMES = ["trips_v2_c_top_advantage_g","trips_v2_b_ds_kicker_max_rank_g","trips_v2_b_ds_kicker_2nd_rank_g","trips_v2_n_kickers_in_trip_suits_g"]
...
def load_model(path: Optional[Path] = None) -> dict:
    ...
    all_gated = [
        ...
        set(_PAIR_R4_GATED_NAMES), set(_TRIPS_GATED_NAMES), set(_TRIPS_V2_GATED_NAMES),
    ]
    ...
    _MODEL_CACHE = {
        ...
        "trips_v2_index_in_full": [feature_columns.index(c) for c in _TRIPS_V2_GATED_NAMES],
...
def strategy_v31b_dt(hand: np.ndarray) -> int:
    model = load_model()
