"""
Session 62 — Test S62 Q-high candidate rules against v52 baseline.

Mirrors test_K_high_candidates_S61.py exactly. Runs each candidate from
candidates_Q_high_S62 through the test_rule_catalog harness on its
...
from candidates_Q_high_S62 import CANDIDATES  # noqa: E402
from strategy_v52_full_high_only_handler import strategy_v52_full_high_only_handler  # noqa: E402

OUT_JSON = ROOT / "data" / "session_62_candidate_results.json"
QUEEN = 12
...
def main() -> int:
    print("=" * 88)
    print("Session 62 — Q-high candidate sweep vs v52 baseline")
    print("=" * 88)
    ...
    for name, (fn, cell) in CANDIDATES.items():
        ...
        try:
            r = test_rule_on_cell(
                rule_fn=fn, max_rank=QUEEN, cell=cell,
